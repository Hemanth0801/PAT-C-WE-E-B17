...
class MathsOperation:
    ...
    @classmethod
    # class methods are methods that takes 'cls' keyword as its declaration.
    # They are used to access class objects.
    def class_method(cls,value):
        cls.factor = value
        return cls.factor

    @staticmethod
    # static methods are methods which are independent of class and instance methods.
    # They dont take any keyword for declaration.
    def addition(x,y):
        total =  x + y
